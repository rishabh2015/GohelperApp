...
public class ServiceDetailListAdapter extends ArrayAdapter<String> {

    private final Activity context;
    private List<ServiceData> arrayList;

    public ServiceDetailListAdapter(Activity context, List<ServiceData> arrayList) {
        super(context, R.layout.service_detail_listview_item);
    ...
    public View getView(int position, View view, @NonNull ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.service_detail_listview_item, null, true);
